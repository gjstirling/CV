...
| [Acebook](https://github.com/Nicola-Carroll/acebook)| A engineering team project creating a facebook clone. <br><br> From this I learned how to work with others in an agile way. I helped develop the front-end interface to create an easy to use user friendly application and reguarly guided the group to clearly define tasks for features. | Ruby on rails, HTML, CSS  |
